...
namespace FONT
{
	...
	const Font lbl_filter{ Create_Font::with_typeface_and_point_height(face_sbld, 14.0f) };
	const Font lbl_lbox_device{ Create_Font::with_typeface_and_point_height(face_sbld, 15.0f) };
	const Font lbl_msg_slot{ Create_Font::with_typeface_and_point_height(face_sbld, 15.0f) };
	...
	const Font tab{ Create_Font::with_typeface_and_point_height(face_sbld, 11.0f) };

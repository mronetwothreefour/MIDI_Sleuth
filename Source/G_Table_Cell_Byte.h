...
private: const int byte_index;
private: const Table_Type table_type;
private: String current_txt;

//==============================================================================
public: Table_Cell_Byte(const int byte_index, const Table_Type table_type, Data_Hub* hub);

private: bool should_be_hilited() const;
public: void paint(Graphics& g) override;
public: void set_row_index(const int index);

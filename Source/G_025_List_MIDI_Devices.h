...
#include "G_027_Delegate_MIDI_Device.h"
...
struct List_MIDI_Devices final :
    ...
    public ListBox
{
private: Component_MIDI_Devices* parent;
private: bool is_input_list;
private: SparseSet<int> last_selected_devices;

//==============================================================================
public: List_MIDI_Devices(const String& name, Component_MIDI_Devices* parent, bool is_input_list);

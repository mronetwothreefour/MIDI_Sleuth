...
namespace FONT
{
	...
	const Font lbl_show_byte{ Create_Font::with_typeface_and_point_height(type_sbld, 15.0f) };
	const Font title_device{ Create_Font::with_typeface_and_point_height(face_bld, 17.0f) };
	const Font title_msg_slot{ Create_Font::with_typeface_and_point_height(face_bld, 17.0f) };
	const Font txt_edit_show_byte{ Create_Font::with_typeface_and_point_height(type_reg, 12.0f) };
